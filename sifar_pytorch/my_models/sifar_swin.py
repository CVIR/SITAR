...
default_cfgs = {
    # patch models (my experiments)
     'swin_tiny_patch4_window7_224_22k': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth',
    ),
    'swin_small_patch4_window7_224_22k': _cfg(
        url='http://github.com/SwinTransformer/storage/releases/download/v1.0.8/swin_small_patch4_window7_224_22k.pth',
    ),
...
def window_partition(x, window_size):
    ...
    """
    B, H, W, C = x.shape
    # print("window partition window size ", window_size, B ,H, W, C)
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(dim=dim, input_resolution=input_resolution,
                                 ...
                                 shift_size=0 if (i % 2 == 0) else  self.window_size[1] // 2 ,
                                 mlp_ratio=mlp_ratio,
...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, img_size=224, num_patches=196,
                 pretrained_window_size=7, pretrained_model="", strict=True, pretrain_path=None, model_type='revswin'):
   ...
   '''
    ...
    for key in state_dict['model']:
        ...
        ##added by owais
        if model_type == 'revswin' and len(pretrained_model) == 0 and ('norm.bias' == key or 'norm.weight' == key):
        ...
        if 1:
            ...
            if 'relative_position_bias_table' in key:
                ...
                # print('pretrained table shape ', pretrained_table.shape)
...
def _create_vision_transformer(variant, pretrained=False, pretrained_window_size=7, **kwargs):
    ...
    model_type = kwargs.pop('model_type', 'revswin')
...
# we are using
@register_model
def sifar_small_patch4_window12_192_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_small_patch4_window12_192_3x3")
    ...
    print("model kwargs")
    print(model_kwargs)
    model = _create_vision_transformer('swin_small_patch4_window7_224_22k', pretrained=pretrained, pretrained_window_size=7, **model_kwargs)
    return model


# we are using
@register_model
def sifar_small_patch4_window12_160_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_small_patch4_window12_160_3x3")
...
# we are using
@register_model
def sifar_base_patch4_window12_160_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_base_patch4_window14_224_3x3")
...
# we are using
@register_model
def sifar_base_patch4_window12_160_3x3_emd192(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_base_patch4_window12_160_3x3_emd192")
    temporal_module_name = kwargs.pop('temporal_module_name', None)
    temporal_attention_only = kwargs.pop('temporal_attention_only', None)
    temporal_heads_scale = kwargs.pop('temporal_heads_scale', 1.0)
    temporal_mlp_scale = kwargs.pop('temporal_mlp_scale', 1.0)
...
# we are using    
@register_model
def sifar_small_patch4_window14_224_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_small_patch4_window12_192_3x3")
 ...
 # we are using
@register_model
def sifar_small_patch4_window12_192_4x4(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_small_patch4_window12_192_3x3")
...
#we are using
@register_model
def sifar_tiny_patch4_window12_192_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_small_patch4_window12_192_3x3")
    ...
    print("model kwargs")
    print(model_kwargs)
    model = _create_vision_transformer('swin_tiny_patch4_window7_224_22k', pretrained=pretrained, pretrained_window_size=7, **model_kwargs)
    return model

# we are using
@register_model
def sifar_small_patch4_window12_192_2x4(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    print("function called: sifar_small_patch4_window12_192_3x3")
...
import sys
sys.path.append('/nobackup/users/rpanda/owais/pytorch-image-models/timm')
from models._builder import build_model_with_cfg 
from models.vision_transformer import VisionTransformer 
from models.vision_transformer import checkpoint_filter_fn
...
def vit_large_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer_vit('vit_large_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_large_patch32_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer_vit('vit_large_patch32_384', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


def _create_vision_transformer_vit(variant: str, pretrained: bool = False, **kwargs) -> VisionTransformer:
